...
<!--           <div class="dropdown-divider"></div>
          <a href="<?php //echo base_url('bill/myprofile') ?> " class="dropdown-item">
            <i class="fas fa-user mr-2"></i> My Profile
          </a>
          <div class="dropdown-divider"></div>
          <a href="<?php //echo base_url('bill/changepassword') ?> " class="dropdown-item">
            <i class="fas fa-lock mr-2"></i> Change Password
          </a>
          <div class="dropdown-divider"></div>
          <a href="<?php //echo base_url('bill/setting') ?> " class="dropdown-item">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo base_url('bill/logout') ?> " class="dropdown-item">
